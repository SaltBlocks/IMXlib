...
std::string imx_signable_order_details(const char* nft_address_str, const char* nft_id_str, bool is_offer, const char* token_id_str, double price, nlohmann::json fee_data, const char* seller_address_str, CURL* curl = NULL);
